...
// React Native requires setPlatform(<bundleId/packageName>)
const client = new Client()
  .setEndpoint(APPWRITE_ENDPOINT)
  .setProject(APPWRITE_PROJECT_ID)
  .setPlatform('com.raven.mobile');
...
export const appwriteConfig = {
  ...
  prescriptionBucketId:
    process.env.EXPO_PUBLIC_PRESCRIPTION_BUCKET_ID || process.env.EXPO_PUBLIC_IMAGES_BUCKET_ID,
